...
void HandleUpdate() {
  ...
  /*
      ...
      object2->GetBoxCollider2D(0).SetAbsolutePosition(object2->GetTexturedRectangle().GetPositionX(),
     object2->GetTexturedRectangle().GetPositionY());
      object2->GetBoxCollider2D(0).SetDimensions(object2->GetTexturedRectangle().GetWidth(),
  ...
  */
  ...
  object1->GetBoxCollider2D(0).SetAbsolutePosition(object1->GetTexturedRectangle().GetPositionX(),
  object1->GetTexturedRectangle().GetPositionY());
  object1->GetBoxCollider2D(0).SetDimensions(object2->GetTexturedRectangle().GetWidth(),
  object1->GetTexturedRectangle().GetHeight()/2);
  object1->GetBoxCollider2D(1).SetAbsolutePosition(object1->GetTexturedRectangle().GetPositionX(),
